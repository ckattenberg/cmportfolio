...
### What is the structure of 'Julia’ [chroma and timbre features]

```{r echo = FALSE}
bzt <-
  get_tidy_audio_analysis("1H7gMYGykdtwZOV6s1N0by") %>%
...
These two self-similarity matrices illustrate pitch and timbre based self similarity in the song "Norwegian Wood" written by John Lennon.
