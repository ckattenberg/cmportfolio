...
```{r echo = FALSE}
hist1 <- ggplot(data = all_songs, mapping = aes(x = tempo)) + 
  geom_histogram(aes(fill = category), position="dodge") +
  theme_light() +
  ggtitle("The Beatles") +
  theme(legend.position="none")

hist2 <- ggplot(data = all_solo, mapping = aes(x = tempo, fill = category)) + 
  geom_histogram( position="dodge") +
  theme_light() +
  ggtitle("Solo") +
  theme(legend.position="none")

hist3 <- ggplot(data = all_songs, mapping = aes(x = tempo, color = category)) + 
  geom_density(alpha=0) +
  theme_light() +
  ggtitle("The Beatles")

hist4 <- ggplot(data = all_solo, mapping = aes(x = tempo, color = category, alpha=0)) + 
  geom_density_line(alpha=0) +
  theme_light() +
  ggtitle("Solo")

grid.arrange(hist1, hist3, hist2, hist4)
```
...
* The difference is a bit larger in their solor work. Paul McCartney has slower songs, on average.
...
```
{=html}
<object data="https://open.spotify.com/embed/track/5SwgE4wA0P7f6AEz2UQMB2?si=hLfnKpjMQtyEdDuCQWo-CQ" width="280" height="140">
    <embed src="https://open.spotify.com/embed/track/5SwgE4wA0P7f6AEz2UQMB2?si=hLfnKpjMQtyEdDuCQWo-CQ" width="280" height="140"></embed>
</object>
```
...
### What is the structure of 'Because’ (chroma and timbre features)
