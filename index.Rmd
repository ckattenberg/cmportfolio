...
First, we will load the playlists containing each artist's songs. Then, we put them all into a single dataframe. 
...
ggplot(data = all_songs) + 
  geom_histogram(mapping = aes(x = valence, fill = category), position = "dodge", binwidth = 0.1) +
  theme_classic() + 
  scale_fill_manual(values=wes_palette(n=4, name="GrandBudapest1")) 

ggplot(data = all_songs) + 
  geom_histogram(mapping = aes(x = energy, fill = category), position = "dodge", binwidth = 0.1) +
  theme_classic()  + 
  scale_fill_manual(values=wes_palette(n=4, name="GrandBudapest1")) 

ggplot(data = all_songs) + 
  geom_histogram(mapping = aes(x = danceability, fill = category), position = "dodge", binwidth = 0.1) +
  theme_classic() + 
  scale_fill_manual(values=wes_palette(n=4, name="GrandBudapest1")) 
